...
md5_images_path_jsonpath = r'D:\PythonProject\find_people\data\md5_images_path.json'
images_path_md5_jsonpath = r'D:\PythonProject\find_people\data\images_path_md5.json'
